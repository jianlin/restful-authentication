...
* or first use `./script/plugin install git://github.com/technoweenie/restful-authentication.git` and then rename the plugin's directory to  `restful_authentication` after fetching it.
